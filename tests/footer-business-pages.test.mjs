...
test("brand story explains the real selection standard and uses an accessible video hero", async () => {
    ...
    assert.match(heroVideo, /src="\/videos\/brand-story\/summer-night-sunny-v3\.mp4"/);
    ...
    const heroVideoSize = (await stat(new URL("public/videos/brand-story/summer-night-sunny-v3.mp4", root))).size;
