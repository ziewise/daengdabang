...
const STRINGS = {
    ko: {
        ...
        shipping: "배송",
        freeShipping: "무료배송",
        shipsIn: "1~2영업일 내 출고 · 결제 후 최대 7일 내 배송",
        twin: "우리 애 트윈",
        sample: "표본",
        ...
        optionRequired: "필수",
        externalCompareLoading: "외부 판매처에서 실제 상품과 가격을 찾고 있어요.",
        externalCompareEmpty: "조건에 맞는 외부 판매 상품을 아직 찾지 못했어요.",
        externalCompareFeedNote: "상품 사진과 판매가가 함께 확인된 결과만 보여드려요. 가격과 배송비는 판매처에서 바뀔 수 있습니다.",
        videoPlay: "영상 재생",
        videoStop: "영상 정지",
    },
    en: {
        ...
        category: "Categories",
        brand: "Brands",
        brandStory: "DaengDaBang Story",
        promotion: "Collections",
        customerCenter: "Support",
        shop: "Shop",
        aiAnalysis: "AI Analysis",
        daengLab: "DaengDaBang Research Lab",
        myPet: "My Pet",
        challenge: "Challenge",
        community: "Community",
        ...
        priceCompare: "Product price comparison",
        searching: "Searching",
        ...
        shipsIn: "Ships in 1-2 business days · delivered within 7 days of payment",
        twin: "Pet Twin",
        sample: "Sample",
        ...
        externalCompareLoading: "Finding real products and prices from other sellers.",
        externalCompareEmpty: "No matching external products have been found yet.",
        externalCompareFeedNote: "Only listings with a product photo and observed price are shown. Seller prices and shipping can change.",
