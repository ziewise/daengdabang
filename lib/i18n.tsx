...
const STRINGS = {
    ko: {
        ...
        optionRequired: "필수",
        externalCompareLoading: "동일 상품과 관련 외부 상품을 확인하는 중입니다.",
        externalCompareEmpty: "아직 확인된 외부 상품 결과가 없습니다.",
        externalCompareFeedNote: "동일 브랜드·모델·규격·수량이 확인된 가격만 정확 비교에 포함합니다.",
        videoPlay: "영상 재생",
        videoStop: "영상 정지",
    },
    en: {
        ...
        priceCompare: "DaengDaBang product price check",
        searching: "Searching",
        ...
        externalCompareLoading: "Checking exact products and related marketplace results.",
        externalCompareEmpty: "No external product results are verified yet.",
        externalCompareFeedNote: "Only matching brand, model, specification and quantity enter the exact comparison.",
