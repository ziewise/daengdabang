...
export const GROWTH_PROGRAM_CARDS: readonly GrowthProgramCard[] = [
    ...
    },
    {
        ...
        eyebrow: "LOCAL CARE",
        title: "동네 돌봄 예약 연결",
        status: "제휴 예약 기능 준비 중",
        description: "주변 후보 찾기는 지금 이용할 수 있고, 한 화면에서 예약까지 이어지는 기능을 준비하고 있어요.",
        details: [
            "병원·미용·호텔·데이케어 위치 검색은 지금 이용 가능",
            "제휴·예약 가능한 업체는 확인 절차를 마친 뒤 별도 표시",
            "현재 후보의 영업·이용 가능 여부는 방문 전 직접 확인",
        ],
        icon: "fa-map-location-dot",
        tone: "teal",
        interestOptions: [{ programId: "local_care", label: "로컬케어 소식 받기" }],
        existingFeature: {
            href: "#local-care-finder",
            label: "병원·미용·호텔·데이케어 후보 찾기",
            helper: "상담으로 이동하지 않고 이 화면에서 현재 위치 주변을 확인합니다.",
        },
    },
] as const;
